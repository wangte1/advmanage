                    ...
                    <div class="col-xs-12">
                        <form  action="" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" required id="form-field-1" value="<?php echo $info['name'];?>" placeholder="请输入登录名" class="col-xs-10 col-sm-5">
                                    <span class="help-inline col-xs-12 col-sm-7">
										<span class="middle" style="color: red">*</span>
									</span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="password" value="" id="form-field-1" placeholder="请输入密码" class="col-xs-10 col-sm-5">
                                     <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" style="color: red">*</span>
								    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="fullname" value="<?php echo $info['fullname']?>"   id="form-field-1" placeholder="请输入真实姓名" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="email"  id="form-field-1" value="<?php echo $info['email']?>"  placeholder="请输入Email" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <label>
                                        <input value="1" name="disabled"   type="radio" class="ace"  <?php if($info['disabled'] == 1){ echo "checked";}?>>
                                        <span class="lbl"> 正常</span>
                                    </label>
                                    &nbsp;&nbsp;
                                    <label>
                                        <input value="2" name="disabled"   type="radio" class="ace"  <?php if($info['disabled'] == 2){ echo "checked";}?>>
