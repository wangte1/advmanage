                    ...
                    <div class="col-xs-12">
                        <form  action="" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" required id="form-field-1" placeholder="客户名称" class="col-xs-10 col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="contact_person" id="form-field-1" placeholder="请输入联系人" class="col-xs-10 col-sm-5">
                                    <span class="help-inline col-xs-12 col-sm-7 form-field-description-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="contact_tel"  id="form-field-1" placeholder="请输入手机号" class="col-xs-10 col-sm-5">
                                     <span class="help-inline col-xs-12 col-sm-7 form-field-description-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="form-field-11" name="remarks" placeholder="（选填）备注信息。最多300字。" class="autosize-transition col-xs-10 col-sm-3" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 52px;"></textarea>
                                </div>
                            </div>
