                    ...
                    <div class="col-xs-12">
                        <form  action="" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="position" rows="2" class="autosize-transition col-xs-10 col-sm-3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="occ_rate">&nbsp;&nbsp;× 100%
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="property_company">
                                </div>
                            </div>
