                ...
                <div class="col-xs-12">
                    <form  action="" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="col-sm-9">
                                <select name="type" class="col-xs-10 col-sm-3">
                                	<?php if(isset($nettype)) {?>
                                		...
                                		<option value="<?php echo $v['id'];?>" <?php if($v['id'] == $info['type']) {?>selected="selected"<?php }?>><?php echo $v['name'];?></option>
                                		<?php }?>
                                	<?php }?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="adform" value="<?php echo $info['adform'];?>"  placeholder="" class="col-xs-10 col-sm-3">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="format" value="<?php echo $info['format'];?>" placeholder="" class="col-xs-10 col-sm-3">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="unitprice" value="<?php echo $info['unitprice'];?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="totalprice" value="<?php echo $info['totalprice'];?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="discount" value="<?php echo $info['discount'];?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="netprice" value="<?php echo $info['netprice'];?>" />
                            </div>
                        </div>
