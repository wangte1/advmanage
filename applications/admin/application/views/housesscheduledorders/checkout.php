                                ...
                                <div class="widget-main">
                                    <form class="form-horizontal" role="form" method="post" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group date datepicker">
                                                    <input class="form-control date-picker" type="text" name="release_start_time" value="<?php if(isset($info['schedule_start'])){ echo $info['schedule_start'];}?>" data-date-format="dd-mm-yyyy" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group date datepicker">
                                                    <input class="form-control date-picker" type="text" name="release_end_time" value="<?php if(isset($info['schedule_end'])){ echo $info['schedule_end'];}?>" data-date-format="dd-mm-yyyy" required>
                                                    <span class="input-group-addon">
                                                        <i class="icon-calendar bigger-110"></i>
                                                    </span>
                                                </div>
