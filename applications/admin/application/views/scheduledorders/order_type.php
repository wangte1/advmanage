                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="blue">
                                        <input name="order_type" value="1" required type="radio" class="ace" checked="checked" />
                                        <span class="lbl"> 公交灯箱 </span>
                                    </label>
                                    &nbsp;
                                    <label class="blue">
                                        <input name="order_type" value="2" required type="radio" class="ace" />
                                        <span class="lbl"> 户外高杆 </span>
                                    </label>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(".btn-next").click(function(){
        ...
        window.location.href = '/scheduledorders/add/' + order_type;
    });
</script>
