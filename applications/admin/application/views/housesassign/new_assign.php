...
$(function(){
	...
	$('.m-detail').click(function(){
		...
		layer.open({
			  ...
			  shade: 0.6,
			  area: ['90%', '95%'],
			  content: '/housesassign/show_ban?order_id='+order_id+'&houses_id='+houses_id+'&charge_id_str='+charge_id_str+'&assign_type='+assign_type+'&remark_str='+remark_str //iframe的url
		}); 
	});
