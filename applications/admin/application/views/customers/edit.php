                    ...
                    <div class="col-xs-12">
                        <form  action="" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="customer_name" value="<?php echo $info['customer_name'];?>" required id="form-field-1" placeholder="客户名称" class="col-xs-10 col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="contact_man" value="<?php echo $info['contact_man'];?>" id="form-field-1" placeholder="请输入联系人" class="col-xs-10 col-sm-5">
                                    <span class="help-inline col-xs-12 col-sm-7 form-field-description-block">
                                       <span class="middle">* 最多可输入20个字符</span>
									</span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="<?php echo $info['contact_mobile'];?>" name="contact_mobile"  id="form-field-1" placeholder="请输入手机号" class="col-xs-10 col-sm-5">
                                     <span class="help-inline col-xs-12 col-sm-7 form-field-description-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="address" value="<?php echo $info['address'];?>"  id="form-field-1" placeholder="请输入客户地址" class="col-xs-10 col-sm-5">
                                     <span class="help-inline col-xs-12 col-sm-7 form-field-description-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="form-field-11" name="remark" placeholder="（选填）备注信息。最多300字。" class="autosize-transition col-xs-10 col-sm-5" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 52px;"><?php echo $info['remark'];?></textarea>
                                </div>
                            </div>
