        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="page-header">
                    <a href="/customers/add" class="btn btn-sm btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i> 新增客户</a>
                </div> 
                                        ...
                                        if($list){
                                            foreach($list as $key=>$val){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $val['contact_man'];?></td>
                                                    <td><?php echo $val['contact_mobile'];?></td>
                                                    ...
                                                    <td>
                                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                            <a class="green tooltip-info" href="/customers/edit/<?php echo $val['id'];?>" data-rel="tooltip" data-placement="top" data-original-title="修改">
                                                                <i class="icon-pencil bigger-130"></i>
                                                            </a>
                                                            <a class="red tooltip-info customer-del" href="javascript:;" data-url="/customers/del/<?php echo $val['id']?>" data-id="<?php echo $val['id'];?>"  data-rel="tooltip" data-placement="top" data-original-title="删除">
