                    ...
                    <div class="col-xs-12">
                        <form  action="" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="version" value="<?php if(isset($info['version'])){ echo $info['version'];}?>" required id="form-field-1" placeholder="版本号 eg: 0.01" class="col-xs-10 col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="url" value="<?php if(isset($info['url'])){ echo $info['url'];}?>" required id="form-field-1" placeholder="下载地址" class="col-xs-10 col-sm-5">
                                   <span class="help-inline col-xs-12 col-sm-7 form-field-description-block">
                                       <span class="middle">* 最多可输入20个字符</span>
									</span>
                                </div>
