                    ...
                    <div class="col-xs-12">
                        <form  action="" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="url"  value="<?php echo $info['url'];?>" required id="form-field-1" placeholder="请输入权限代码" class="col-xs-10 col-sm-5">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" style="color: red">*</span>
									</span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name"  value="<?php echo $info['name'];?>" required id="form-field-1" placeholder="请输入权限名称" class="col-xs-10 col-sm-5">
                                     <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" style="color: red">*</span>
								    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sort" value="<?php echo $info['sort'];?>" required id="form-field-1"  class="col-xs-10 col-sm-5">
                                     <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" style="color: red">*</span>
								    </span>
                                </div>
