        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="page-header">
                    <a href="/specification/add" class="btn btn-sm btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i> 添加规格</a>
                </div> 
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo C('public.media_type')[$value['type']];?></td>
                                                ...
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a class="green tooltip-info" href="/specification/edit/<?php echo $value['id'];?>" data-rel="tooltip" data-placement="top" data-original-title="修改">
                                                            <i class="icon-pencil bigger-130"></i>
                                                        </a>

                                                        <?php if($value['is_del'] == 0):?>
                                                        <a class="red tooltip-info del-spa" data-id="<?php echo $value['id'];?>" data-del="1" data-rel="tooltip" data-placement="top" data-original-title="删除">
                                                            <i class="icon-trash bigger-130"></i>
                                                        </a>
                                                        <?php else:?>
                                                        <a class="red tooltip-info" href="/specification/del/<?php echo $value['id'];?>/0" data-rel="tooltip" data-placement="top" data-original-title="恢复">
