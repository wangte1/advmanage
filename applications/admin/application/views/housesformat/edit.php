                    ...
                    <form  action="" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="select2" name="type">
                                    	<?php foreach ($order_type_text as $k => $v) {?>
                                             <option value="<?php echo $k;?>" <?php if($k == $info['type'] ) {?>selected="selected"<?php }?>><?php echo $v;?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="size"  id="form-field-1" value="<?php echo $info['size'];?>" placeholder="请输入点位尺寸" class="col-xs-10 col-sm-3">
                                </div>
                            </div>
